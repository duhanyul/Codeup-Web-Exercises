...
function pageController($allMovies)
{
    ...
    if(isset($_GET['genre'])) {
      ...
      foreach ($allMovies as $movie) {
        if (strcasecmp($title,$movie['title']) == 0) {
          $movies[] = $movie;
        }
      }
      $data['movies'] = $movies;
    ...
    <main class="container">
        ...
        <section class="form">
            <form action="movies.php" method="get">
                ...
                <input type="text" name="title" value="" placeholder="Search by movie title">
            ...
            <form  action="movies.php" method="get">
              <input type="text" name="genre" value="" placeholder="Search by movie genre">
              <input type="submit" name="" value="search">
            </form>
        </section>
